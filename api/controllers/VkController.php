    ...
    public function actionWebhook()
    {
        try {
            ...
            if ($type === 'message_new') {
                ...
                // Коды имеют длину 20 символов и генерируются случайно (буквы, цифры и подчеркивания)
                // Проверяем, является ли текст кодом подтверждения (длина 20 символов и только буквы/цифры/подчеркивания)
                // Используем mb_strlen для правильного подсчета символов в UTF-8
                $textLength = mb_strlen($text, 'UTF-8');
                // Проверяем, что код состоит только из букв, цифр и подчеркиваний (без пробелов, эмодзи и других символов)
