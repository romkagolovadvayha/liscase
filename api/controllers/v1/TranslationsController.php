 ...
 * Язык: Accept-Language (en-US, ru-RU) или ?language=en-US.
 * Параметр ?keys=key1,key2 — недостающие ключи автоматически добавляются в БД (category=frontend, translation=ключ).
 */
