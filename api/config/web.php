    ...
    'components' => [
        ...
        'urlManager'    => [
            ...
            'v1/banlist' => 'v1/banlist/index',
                ...
                ['pattern' => 'v1/rust-menu/notifications', 'route' => 'v1/rust-menu/notifications', 'verb' => ['GET', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/notifications/settings', 'route' => 'v1/rust-menu/notifications-settings', 'verb' => ['POST', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop', 'route' => 'v1/rust-menu/shop', 'verb' => ['GET', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/buy', 'route' => 'v1/rust-menu/shop-buy', 'verb' => ['POST', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/favorite', 'route' => 'v1/rust-menu/shop-favorite', 'verb' => ['POST', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/balance', 'route' => 'v1/rust-menu/shop-balance', 'verb' => ['GET', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/topup', 'route' => 'v1/rust-menu/shop-topup', 'verb' => ['POST', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/topup/qr', 'route' => 'v1/rust-menu/shop-topup-qr', 'verb' => ['GET', 'OPTIONS']],
                ['pattern' => 'v1/rust-menu/shop/topup/resolve', 'route' => 'v1/rust-menu/shop-topup-resolve', 'verb' => ['GET', 'OPTIONS']],
