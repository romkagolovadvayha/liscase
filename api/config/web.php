    ...
    'components' => [
        ...
        'urlManager'    => [
            ...
            'rules' => [
                ...
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/logo', 'route' => 'v1/clans/upload-logo', 'verb' => ['POST']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/invite-links/<linkId:\d+>', 'route' => 'v1/clans/invite-links-delete', 'verb' => ['DELETE']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/invite-links', 'route' => 'v1/clans/invite-links-create', 'verb' => ['POST']],
                'v1/clans/<serverTag:[\w-]+>/<id:\d+>/invite-links' => 'v1/clans/invite-links-list',
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/apply', 'route' => 'v1/clans/apply', 'verb' => ['POST']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/applications/<appId:\d+>/accept', 'route' => 'v1/clans/application-accept', 'verb' => ['POST']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/applications/<appId:\d+>/reject', 'route' => 'v1/clans/application-reject', 'verb' => ['POST']],
                'v1/clans/<serverTag:[\w-]+>/<id:\d+>/applications' => 'v1/clans/applications-list',
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/posts/<postId:\d+>', 'route' => 'v1/clans/post-delete', 'verb' => ['DELETE']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/posts/<postId:\d+>', 'route' => 'v1/clans/post-update', 'verb' => ['PATCH', 'PUT']],
                ['pattern' => 'v1/clans/<serverTag:[\w-]+>/<id:\d+>/posts', 'route' => 'v1/clans/post-create', 'verb' => ['POST']],
