...
/**
 * Switches annual medals to distinct Rust item themes and unique frame silhouettes.
 */
class m260817_010000_make_annual_medals_rust_distinct extends Migration
{
    private const ANNUAL_PATHS = [
        'annual_playtime_2021' => [
            'new' => '/images/awards/veteran-2021-v4.webp',
            'old' => '/images/awards/veteran-2021-v3.webp',
        ],
        'annual_playtime_2022' => [
            'new' => '/images/awards/veteran-2022-v4.webp',
            'old' => '/images/awards/veteran-2022-v3.webp',
        ],
        'annual_playtime_2024' => [
            'new' => '/images/awards/veteran-2024-v4.webp',
            'old' => '/images/awards/veteran-2024-v3.webp',
        ],
        'annual_playtime_2025' => [
            'new' => '/images/awards/veteran-2025-v4.webp',
            'old' => '/images/awards/veteran-2025-v3.webp',
        ],
        'annual_playtime_2026' => [
            'new' => '/images/awards/veteran-2026-v4.webp',
            'old' => '/images/awards/veteran-2026-v3.webp',
        ],
    ];

    private const BATTLE_PASS_NEW_PATH = '/images/battlepass/season-1-medal-v5.webp';
    private const BATTLE_PASS_OLD_PATH = '/images/battlepass/season-1-medal-v4.webp';
