...
return [
    ...
    'programs' => [
        ...
        'prostoj.node.discord.send.max3' => [
            'directory'       => '@common/node/discord/src',
        ...
        // ===== Radio / Music =====
        'prostoj.node.radio1' => [
            'directory'       => '@common/node/mode/sounds/1',
            'command'         => 'node ../../app.js',
        ...
        'prostoj.node.radio2' => [
            'directory'       => '@common/node/mode/sounds/2',
            'command'         => 'node ../../app.js',
        ...
        'prostoj.node.discord.roles' => [
            'directory'       => '@common/node/discord-roles/src',
