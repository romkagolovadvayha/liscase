...
class MapLocalization
{
    ...
    private const MONUMENT_TRANSLATIONS = [
        'ru-RU' => [
            ...
            'Outpost' => 'Аванпост',
            'Excavator' => 'Гигантский экскаватор',
            'Карьер' => 'Гигантский экскаватор',
            ...
            'Sphere Tank' => 'Сфера',
            'Купол' => 'Сфера',
            'Military Base A' => 'Военная база A',
            'Military Base B' => 'Военная база B',
            'Military Base C' => 'Военная база C',
            'Military Base D' => 'Военная база D',
            ...
            'Underwater Lab A' => 'Подводная лаборатория A',
            'Underwater Lab B' => 'Подводная лаборатория B',
            'Underwater Lab C' => 'Подводная лаборатория C',
