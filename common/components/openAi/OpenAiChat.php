...
- type=1 — только если есть явное слово о родителях: мать, мам, мамка, отец, пап, батя, родител… и т.п.
- type=2 — есть слова админ/админы/модер(атор) и одновременно ругань.
...
анти-примеры: «ты ебанько → не type=1», «не трогай моего парня → не type=2».
