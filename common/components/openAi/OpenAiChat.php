...
- type=3 (просит помощи админа) — есть ["админ","админы","модер"] и рядом (±30 символов) слова
  ["помоги","помощь","help","жалоб","репорт","f7","как связаться","куда жалобу"].
  Если одновременно присутствует оскорбление администрации — отнести к type=2 (приоритет 2 > 3).
При совпадении нескольких правил приоритет: 1 > 2 > 3.
