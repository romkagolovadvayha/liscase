...
- type=1 (оскорбление родителей) — ТОЛЬКО если сообщение содержит явное упоминание родителей
...
- type=2 — оскорбление администрации: есть слова ["админ","админы","модер","модератор"] И оскорбление.
- type=3 — просьба помощи админу: ["админ","админы","модер"] рядом с "помоги","помощь","help",
