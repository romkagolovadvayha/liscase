...
class OpenAiVkPost extends \yii\base\Component
{
    ...
    public function processForVk(string $title, string $content, ?string $description = null): ?string
    {
        ...
        $prompt .= "Напиши кратко статью для поста ВКонтакте без изображений, используй смайлы.";

        // Сообщения для OpenAI
        $messages = [
            [
                'role' => 'system',
                'content' => 'Ты SMM-копирайтер, создающий посты для ВКонтакте. Используй смайлы и эмодзи.'
            ],
