 ...
 */
class MidjourneyImageCreator extends \batdan\ai\MidjourneyImageCreator
{
    ...
    private function getImagine(string $prompt)
    {
        ...
        while (is_null($imagine_message)) {
            ...
            if (isset($imagine_message['id']) && empty($imagine_message['id'])) {
                $imagine_message = null;
                break;
            }
    ...
    private function checkImagine()
    {
        ...
        foreach ($items as $item) {
            ...
            if (str_contains($item['content'], $this->uniqueId)) {
                $find = true;
            }
