    ...
    internal class Barges : RustPlugin
    {
        ...
        private class PluginConfig
        {
            ...
            public static PluginConfig DefaultConfig()
            {
                ...
                {
                    Version = new VersionNumber(1, 2, 7),
                    Prefix = "[Barges]",
        ...
        private class Barge : FacepunchBehaviour
        {
            ...
            private void SpawnModule(BargeModuleConfig presetLocationConfig, bool firstSpawn, ref HashSet<BoxColliderInfo> boxColliderInfos)
            {
                ...
                parentEntity.canTriggerParent = false;
            ...
            private void SpawnPrefab(CustomPrefabData customPrefabData, BaseEntity parentEntity, bool firstSpawn)
            {
                ...
                foreach (BuildingBlockData buildingBlockData in customPrefabData.BuildingBlocks)
                {
                    ...
                    buildingBlock.canTriggerParent = false;
                    buildingBlock.grounded = true;
                }
        ...
        private class BargeCaller : FacepunchBehaviour
        {
            ...
            private void OnDestroy()
            {
                ...
                else if (_ins.IsPositionOutsideGrid(transform.position))
                {
                    LootManager.GiveItemToPLayer(_player, _bargeConfig.ItemConfig, 1);
                    NotifyManager.SendMessageToPlayer(_player, "TooFarFromShore");
                }
                else
                {
                    CallBarge();
                ...
                protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TooFarFromShore"] = "Вы слишком далеко от берега!",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TooFarFromShore"] = "You are too far from the shore!",
        ...
        private class BargePhysics : FacepunchBehaviour
        {
            ...
            private void CreateFakePhysicEntity()
            {
                ...
                _fakePhysicsEntity.canTriggerParent = false;
            ...
            private void CheckShoreDistance()
            {
                ...
                if (!_ins.IsPositionOutsideGrid(_fakePhysicsEntity.transform.position))
                    return;
        ...
        private class BuildingVisibilityManager : FacepunchBehaviour
        {
            ...
            {
                if (buildingBlock == null || buildingBlock.net == null ||  buildingBlock.net.group == null || buildingBlock.net.group.subscribers == null || buildingBlock.net.group.subscribers.Count == 0)
                    return;
        ...
        {
            float xDistanceToShore = Mathf.Abs(position.x) - World.Size / 2f;
            float zDistanceToShore = Mathf.Abs(position.z) - World.Size / 2f;
            float distanceToShore = Mathf.Max(xDistanceToShore, zDistanceToShore);
            return distanceToShore > _ins._config.MainConfig.MaxShoreDistance;
        }
