...
<div class="page-wipe-calendar">
                                        ...
                                        <article class="event">
                                            ...
                                            <div class="event-meta">
                                                <?php if (!empty($ev['is_official'])): ?>
                                                    <span class="badge badge-official"><?= Yii::t('common', 'обновление') ?></span>
                                                <?php endif; ?>
    ...
    <section class="seo-block">
        ...
        <ul class="mt-12">
            <li><?= Yii::t('common', 'Бейдж «обновление» отмечает официальный глобальный патч (обычно первый четверг месяца).') ?></li>
