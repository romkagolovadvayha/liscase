...
<div class="widget_bonus">
    ...
    <div class="widget_bonus_item">
        <span class="widget_bonus_item_sum"><?=Yii::t('common', 'от 1000 RUB')?></span>
        <span class="widget_bonus_item_percent">+20%</span>
    </div>
    <div class="widget_bonus_item">
        <span class="widget_bonus_item_sum"><?=Yii::t('common', 'от 1500 RUB')?></span>
        <span class="widget_bonus_item_percent">+25%</span>
    </div>
    <div class="widget_bonus_item">
        <span class="widget_bonus_item_sum"><?=Yii::t('common', 'от 2000 RUB')?></span>
        <span class="widget_bonus_item_percent">+30%</span>
    </div>
    <div class="widget_bonus_item">
        <span class="widget_bonus_item_sum"><?=Yii::t('common', 'от 5000 RUB')?></span>
