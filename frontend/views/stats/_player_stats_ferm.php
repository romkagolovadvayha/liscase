...
$items = [
    ...
    ['key' => 'gathered_orchid', 'name' => Yii::t('common', 'Орхидея'), 'score' => 0.1],
    ['key' => 'gathered_rose', 'name' => Yii::t('common', 'Розы'), 'score' => 0.1],
    ['key' => 'gathered_sunflower', 'name' => Yii::t('common', 'Подсолнух'), 'score' => 0.1],
    ['key' => 'gathered_wheat', 'name' => Yii::t('common', 'Пшеница'), 'score' => 0.1],
];
