...
<div class="page_content">
    ...
    <div class="page_content_body">
        ...
        <p></p><h2 class="mt-40">1. Общие положения</h2>
        ...
        <p></p>
        <p>
        </p><h2 class="mt-40">2. Состав информации о Пользователях, которую получает и обрабатывает Администрация</h2>
        ...
        <p></p>
        <p>
        </p><h2 class="mt-40">3. Цели сбора и обработки информации о Пользователях</h2>
        ...
        <p></p>
        <p>
        </p><h2 class="mt-40">4. Обработка информации о Пользователях</h2>
        ...
        <p></p>
        <p>
        </p><h2 class="mt-40">5. Меры по защите информации о Пользователях </h2>
