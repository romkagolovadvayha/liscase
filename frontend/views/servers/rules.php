                ...
                <ol>
                    ...
                    <li class="not_num">
                        ...
                        <ol>
                            ...
                            <li><?=Yii::t('common', 'Все проверки проходят через AnyDesk, отказ будет приравниваться к отказу от проверки')?> <span class="rules_punishment">[ban]</span></li>
