...
<style>
    ...
    .servers_daily_bonus_command {
        color: var(--server-command);
        font-weight: 700;
    }
</style>
<div class="servers_daily_bonus">
    <p>Связи с тем, что платежные системы против размещения на сайте ежедневного крейта.</p>
    <p>Ежедневный бонус мы перенесли в наш телеграм бот <a href="https://t.me/<?=Yii::$app->settings->get('tgbot_login')?>" target="_blank">@<?=Yii::$app->params['tgPersonalBot']?></a></p>
