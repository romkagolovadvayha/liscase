...
/** @var NewsContentSearch $searchModel */
...
<div class="admin-filters-content bg-[hsl(0_0%_20.4%_/_1)] border-l border-[hsl(0_0%_15.3%_/_1)] h-full overflow-y-auto scrollbar-thin">
    ...
    <div class="p-4 flex-1">
        <div class="mb-6">
            ...
            <div class="space-y-3">
                <div>
                    <label for="newscontentsearch-language" class="text-xs text-gray-400 mb-1 block">Язык</label>
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'language', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            ArrayHelper::merge(['' => 'Все'], $searchModel->getLanguageList()),
    ...
    <div class="p-4 border-t border-[hsl(0_0%_15.3%_/_1)]">
        ...
        <a href="<?= Url::to(Yii::$app->request->url) ?>" class="ds-btn ds-btn--secondary ds-btn--sm w-full justify-center block text-center mt-2"><i class="fas fa-redo"></i> Сбросить</a>
    </div>
    <?php ActiveForm::end(); ?>
</div>
