...
?>
<div class="setting_items_item_block setting_items_item_block_text flex flex-col gap-2">
    ...
    <?= Html::input('number', 'settings[' . $item->id . ']', $item->value, ['class' => 'ds-input form-control w-full']) ?>
</div>