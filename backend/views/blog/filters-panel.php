    ...
    <div class="p-4 flex-1">
        <div class="mb-6">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <label class="text-xs text-gray-400 mb-1 block"><?= $searchModel->getAttributeLabel('blog_category_id') ?></label>
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'blog_category_id', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            ArrayHelper::merge(['' => Yii::t('common', 'Все')], BlogCategory::getChildsCategories()),
                ...
                <div>
                    ...
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'status', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            ArrayHelper::merge(['' => Yii::t('common', 'Любой')], Blog::getStatusList()),
