...
<div class="admin-filters-content bg-[hsl(0_0%_20.4%_/_1)] border-l border-[hsl(0_0%_15.3%_/_1)] h-full overflow-y-auto scrollbar-thin">
    ...
    <div class="p-4 flex-1">
        <div class="mb-6">
            ...
            <div class="space-y-3">
                <div>
                    <label for="userdropsearch-steam_id" class="text-xs text-gray-400 mb-1 block"><?= \Yii::t('common', 'Steam ID') ?></label>
                ...
                <div>
                    <label for="userdropsearch-status" class="text-xs text-gray-400 mb-1 block"><?= \Yii::t('common', 'Статус (инвентарь)') ?></label>
                ...
                <div>
                    <label for="userdropsearch-drop_in_store" class="text-xs text-gray-400 mb-1 block"><?= \Yii::t('common', 'Активен в магазине') ?></label>
                    <div class="ds-select-wrapper">
                ...
                <div>
                    <label for="userdropsearch-user_username" class="text-xs text-gray-400 mb-1 block"><?= \Yii::t('common', 'Пользователь') ?></label>
                ...
                <div>
                    <label for="userdropsearch-drop_name" class="text-xs text-gray-400 mb-1 block"><?= \Yii::t('common', 'Предмет') ?></label>
