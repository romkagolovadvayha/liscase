    ...
    <div class="p-4 flex-1">
        <div class="mb-6">
            ...
            <div class="space-y-3">
                ...
                <div>
                    <label class="text-xs text-gray-400 mb-1 block">Пользователь</label>
                    <?= $form->field($searchModel, 'user_username', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->textInput([
                        'class' => 'ds-input w-full text-sm', 'placeholder' => 'Ник',
                    ]) ?>
                </div>
                <div>
                    <label class="text-xs text-gray-400 mb-1 block">Сервер</label>
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'server_id', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            ArrayHelper::merge(['' => 'Все'], $serversList),
                ...
                <div>
                    ...
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'status', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            ArrayHelper::merge(['' => 'Все'], UserDrop::getStatusList()),
                            ['class' => 'ds-select', 'prompt' => 'Все']
                        ) ?>
                        <i class="fas fa-chevron-down ds-select-arrow"></i>
                    </div>
