...
<div class="admin-filters-content bg-[hsl(0_0%_20.4%_/_1)] border-l border-[hsl(0_0%_15.3%_/_1)] h-full overflow-y-auto scrollbar-thin">
    ...
    <div class="p-4 flex-1">
        <div class="mb-6">
            ...
            <div class="space-y-3">
                <div>
                    <label for="promocode-filter-code" class="text-xs text-gray-400 mb-1 block">Код</label>
                    <?= $form->field($searchModel, 'code', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->textInput([
                        'class' => 'ds-input w-full text-sm', 'id' => 'promocode-filter-code', 'placeholder' => 'Промокод',
                    ]) ?>
                </div>
                <div>
                    <label for="promocode-filter-status" class="text-xs text-gray-400 mb-1 block">Статус</label>
                    <div class="ds-select-wrapper">
                        <?= $form->field($searchModel, 'status', ['options' => ['class' => 'mb-0'], 'template' => '{input}'])->dropDownList(
                            Promocode::getStatusList(),
                            ['class' => 'ds-select', 'id' => 'promocode-filter-status', 'prompt' => 'Все']
                        ) ?>
